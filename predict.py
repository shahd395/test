...
def runJob(req_data):
    ...
    if form.getvalue('q37') == "5":
        print ('نتيجة الفحص: مصاب                             ويترتب على ذلك :  1. إجراء الفحص المخبري للتأكد من الإصابة بنسبة أكبر                                2. القيام بالعزل المنزلي، وفي حال شعرت بأي تعب يحتاج لتدخل طبي اتصل بالجهات المعنية كالطب الوقائي                                3. المحافظة على تناول المكملات الغذائية والفيتاميان إما على شكل أدوية بوصفة طبية، وإما عن طريق الخضار كالفلفل الحلو الغني بفيتامين د، والفواكه الحمضية')
